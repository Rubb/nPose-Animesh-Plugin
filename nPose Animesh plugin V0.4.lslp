...
integer SFlagFlying;
integer SFlagFlyingUp;
integer SFlagFlyingDown;
...
string FlyingAnims;
string SittingAnims;
string FlyingDownAnims;
string FlyingUpAnims;
...
//            string MeshName = llList2String(Parts, 0);
            ...
            for (listIndex = 0; listIndex < listStop; ++listIndex) {
                ...
                else if (optionItem == "flyingup") {
                    FlyingUpAnims = optionString;
                }
                else if (optionItem == "flyingdown") {
                    FlyingDownAnims = optionString;
                }
    ...
    sensor(integer total_number) {
        if (followFlag || gotoFlag) {
            ...
            else if (followFlag && (AVstatus == "Hovering Up") && !SFlagFlyingUp) {
                llSensorRemove();
                llSetStatus(STATUS_PHYSICS, FALSE);
                llMessageLinked(LINK_SET, 200, FlyingUpAnims, "");
                SFlagWalking = 0;
                SFlagStanding = 0;
                SFlagSitting = 0;
                SFlagFlying = 0;
            ...
            else if (followFlag && (AVstatus == "Hovering Down") && !SFlagFlyingDown) {
                llSensorRemove();
                llSetStatus(STATUS_PHYSICS, FALSE);
                llMessageLinked(LINK_SET, 200, FlyingDownAnims, "");
                SFlagWalking = 0;
                SFlagStanding = 0;
                SFlagSitting = 0;
                SFlagFlying = 0;
